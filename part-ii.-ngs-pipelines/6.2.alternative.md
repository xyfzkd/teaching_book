...
探索 SRR065547 与 SRR065546 之间在 X 染色体上存在 differential splicing 的基因, `.bam` 文件可在 [这里](https://github.com/dongzhuoer/lulab-teaching_book-data/tree/master/AS) 下载（需要上交：`b1.txt` 和 `b2.txt` 文件）
