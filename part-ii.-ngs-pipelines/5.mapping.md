...
我们使用 bowtie 软件将 reads 比对到基因组。之后可以可视化比对出的结果。常用的软件和网站包括[IGV](https://software.broadinstitute.org/software/igv/download)和[UCSC](https://genome.ucsc.edu/cgi-bin/hgTracks)。[IGV 清华云下载](https://cloud.tsinghua.edu.cn/d/f3467fe778754830b2d9/) ，[IGV 网站下载](https://software.broadinstitute.org/software/igv/download) 
