...
The example `.bam` files (in `/home/test/chip-seq`) come from yeast ChIP-seq, you can also download them [here](https://github.com/dongzhuoer/docker-lulab-chipseq/tree/master/data/input).
