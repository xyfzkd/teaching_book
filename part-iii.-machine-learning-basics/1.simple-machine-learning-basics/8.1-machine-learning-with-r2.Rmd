...
- Image your data contains only 5 row, the 80 percent is 5 * 0.8 = 4 (here `nrow_training` is `4`). 
...
- And `testing` contains the 4th row of `df`  (`[-indexes, ]` means not to choose these rows, so only 4th is left)
