...
我们选用随机森林（Random Forest）模型作为示例讲解机器学习。
...
以下代码在训练集上训练一个由100棵分类树组成的随机森林模型：
...
<tbody>
	<tr><th scope=row>55</th><td>0.964</td><td>0.036</td></tr>
	<tr><th scope=row>56</th><td>1.000</td><td>0.000</td></tr>
	<tr><th scope=row>57</th><td>0.958</td><td>0.042</td></tr>
	<tr><th scope=row>64</th><td>0.992</td><td>0.008</td></tr>
	<tr><th scope=row>70</th><td>1.000</td><td>0.000</td></tr>
	<tr><th scope=row>77</th><td>0.880</td><td>0.120</td></tr>
</tbody>
</table>
...
=======
学习和使用教程中的代码，使用下面的数据，练习随机森林模型，在训练集上训练，在测试集上预测，汇报模型的预测表现: 包括 accuracy, sensitivity, specificity, roc_auc等指标，绘制ROC曲线。
>>>>>>> 7cdcc36ff5d3942fe1664bd005b8ab78cc0b57cb
