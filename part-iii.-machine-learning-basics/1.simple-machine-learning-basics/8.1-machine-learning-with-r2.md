...
> `predicted_value` and `real_value` both contains 20 values, correspond
> to 20 rows of testing data. Each value tells a row belongs which
> species, the former is the model’ precdiction, the latter is the real
> case.
