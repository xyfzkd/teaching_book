...
* yeast基因组注释可以从浏览器下载gtf的压缩文件：​[Download Link](.gitbook/files/1.gtf.gz)
...
less -S 1.gtf | head -15  #显示1.gtf文件前15行(输入时15可以用其他整数替代)
​
...
3. 统计 IV 号染色体上各类 feature （1.gtf文件的第3列） 的数目，并按升序排列。
