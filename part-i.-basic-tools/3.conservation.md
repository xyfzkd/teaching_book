...
![导入fasta文件](.gitbook/assets/conservation-import-fasta.gif)
![多序列比对](.gitbook/assets/conservation-alignment.gif)
![发育树构建](.gitbook/assets/conservation-tree-construction.gif)
![个性化设置与结果导出](.gitbook/assets/conservation-configuration-and-export.gif)
